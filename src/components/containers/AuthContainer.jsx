...
function AuthContainer({children, inup, pb=""}) {
  return (
    <div className={`w-full pb-20 pt-5 ${inup === "in" ? "sm:pt-20": "sm:pt-10"}  sm:pb-0 min-h-screen flex items-center justify-center sm:justify-start sm:items-start  sm:pl-24 aflex-col`}>
